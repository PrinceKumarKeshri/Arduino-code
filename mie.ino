...
void loop(void) {
    ...
    const char *aspectname[] = {
        "CHANDIGARH_GROUP_OF_COLLEGE", "TECHYONS", "CGCTC", "MY_NAME_IS"
    };
...
void runtests(void)
{
    ...
    RUNTEST(4, "RECTANGLE (outline)     ", testRects(GREEN));
    RUNTEST(5, "RECTANGLE (filled)      ", testFilledRects(YELLOW, MAGENTA));
